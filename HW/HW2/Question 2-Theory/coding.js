...
function display2_2() {
  var myanswer  = "My answer goes here: The var x won't appear, since it is under the strict mode. If it's removed, the var x will be displayed." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: What we find about div_1134 in HTML is display:None that's why it's unable to view." // TODO 2.5: Fill in Answer here
